...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($level) || empty($course) || empty($semester)) {
        ...
        $stmt = $conn->prepare("INSERT INTO mentees (unique_id, level, course, semester) VALUES (:unique_id, level, :course, :semester)");
...
<body>
    <div class="wrapper">
        <section class="form mentee">
            ...
            <form action="mentee-need.php" method="POST" enctype="multipart/form-data" autocomplete="off">
